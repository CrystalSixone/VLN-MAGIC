...
def parse_args():
    ...
    parser.add_argument('--num_workers', type=int, default=6) # multiprocess to load datasets
    ...
    parser.add_argument("--rw_temp", type=float, default=1) # the soft temperature of RW adaptive weight
    parser.add_argument("--aw_update_iter", type=int, default=3000) # the iterations of the adaptive weights
    
    parser.add_argument("--teacher_sample_hard_mining", action='store_true', default=False) # Sample-level adjustment based on teacher's loss
    parser.add_argument("--t_sample_preprocess", type=str, default='exp') # exp / norm
    ...
    parser.add_argument("--teacher_intermediate_size", type=int, default=3072)
    parser.add_argument('--teacher_resume_file', type=str, default=None)
    parser.add_argument('--teacher_bert_ckpt_file', type=str, default=None)
    parser.add_argument('--teacher_num_l_layers', type=int, default=6)
    parser.add_argument('--teacher_num_pano_layers', type=int, default=2)
    parser.add_argument('--teacher_num_x_layers', type=int, default=3)
    parser.add_argument('--t_frontdoor_dict_file', type=str, default='')
    ...
    parser.add_argument('--student_num_l_layers', type=int, default=6)
    parser.add_argument('--student_num_pano_layers', type=int, default=2)
    parser.add_argument('--student_num_x_layers', type=int, default=3)
    parser.add_argument('--student_bert_ckpt_file', type=str, default=None)
    parser.add_argument('--s_backdoor_dict_file', type=str, default='')
    parser.add_argument('--s_frontdoor_dict_file', type=str, default='')
    
    parser.add_argument('--kd_loss_type', type=str, default='sum') # sum / mean
...
def postprocess_args(args):
    ...
    cfp_file_map = {
        ...
        384: 'vlnkdl_cfp_features_384.tsv',
        256: 'vlnkdl_cfp_features_256.tsv',
        128: 'vlnkdl_cfp_features_128.tsv',
        'l9x6p2_768': 'r2r_l9x6p2_cfp_features.tsv'  
    }
    
    rxr_cfp_file_map = {
        768: 'rxr_cfp_features.tsv',
        384: 'rxr_vlnkdl_cfp_features_384.tsv',
        256: 'rxr_vlnkdl_cfp_features_256.tsv',
