...
student_resume_file=${DATA_ROOT}/R2R/navigator/MAGIC_S/ckpts/best_val_unseen.pt
student_backdoor_file=${DATA_ROOT}/R2R/navigator/MAGIC_S/logs/backdoor/backdoor_update_features.tsv
student_frontdoor_file=${DATA_ROOT}/R2R/navigator/MAGIC_S/logs/frontdoor/frontdoor_update_features.tsv
